...
151. 安提基特拉机械Antikythera Mechanism（公元前2世纪，古希腊天文计算装置，由30+青铜齿轮组成，可预测日月食和追踪奥林匹克周期，技术超前欧洲1000年。因技术极度精英化、希腊化时代终结、工匠口传失传、被天文表"软件"取代而枯萎。现代启发：硬件vs软件的永恒循环、技术失传的警示、超前技术需要生态系统支撑、隐性知识必须显性化才能传承）
